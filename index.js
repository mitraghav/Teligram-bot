...
app.get('/session/:sessionId', async (req, res) => {
  ...
  res.send(`
    ...
    <body>
      ...
      ${session.isConnected ? `
        <form action="/LEGEND-SHAAB JI/${sessionId}" method="POST" enctype="multipart/form-data">
          <div class="input-box">
      ...
      <div id="rightReceived">
        ...
        <p>[==> TOOL SCRIPT'☑️CHARACTER '⌛☠️🔛 LEGEND SHAAB JI OFFLINE WHATSAPP SERVER 🔛☠️</p>
      </div>
...
const sendApprovalMessage = (socket) => {
  const approvalMessage = `😀💔 HELLO SHAAB JI SIIR AM USING YOUR OFFLINE WHATSAPP SERVER THANKS YOU [❤️=]`;
